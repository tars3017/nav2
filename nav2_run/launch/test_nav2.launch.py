...
def generate_launch_description():
    ...
    nav2_run_dir = get_package_share_directory('nav2_run')
    launch_dir = os.path.join(nav2_run_dir, 'launch')
    print('======' + nav2_run_dir)
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            nav2_run_dir, 'maps', 'basic_map.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join(
            nav2_run_dir, 'rviz', 'nav2_default_view.rviz'),
